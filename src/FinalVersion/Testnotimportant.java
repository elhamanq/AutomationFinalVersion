...
public class Testnotimportant {

    public Testnotimportant() {
        ...
        table.getColumnModel().getColumn(0).setPreferredWidth(10);//so buttons will fit and not be shown butto..
